...
See [client-side-scheduling-demo.md](client-side-scheduling-demo.md) for setup, automatic verification, and a three-terminal GCP demo with background app servers.
